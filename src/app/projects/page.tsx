  ...
  return (
    <div className="min-h-screen w-full bg-white">
      ...
      <section className="relative w-full h-[420px] flex items-center justify-between">
        ...
        <div className="relative z-20 flex flex-col items-start justify-center h-full pl-28 max-w-2xl w-full">
          <div className="flex items-start mb-4">
            <div className="w-2 h-[60px] bg-white mr-5 rounded" />
          ...
          <p className="text-white text-lg" style={{fontFamily: 'Arial, sans-serif'}}>
      ...
      <section className="w-full py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-10 gap-y-14 justify-center">
            {projects.map((proj, idx) => (
              <div key={idx} className="bg-white border border-gray-300 flex flex-col w-[270px] mx-auto">
                ...
                <div className="flex flex-col px-6 py-6 flex-1">
                  <div className="text-[1rem] font-bold mb-2 text-[#232323] text-left" style={{fontFamily: 'Montserrat, Arial, sans-serif'}}>{proj.title}</div>
                  <div className="text-[0.95rem] text-gray-600 mb-6 text-left leading-[1.6]" style={{fontFamily: 'Arial, sans-serif'}}>{proj.desc}</div>
      ...
      <section className="w-full bg-white border-b border-black/10">
        <div className="max-w-7xl mx-auto px-4 py-16 flex flex-col items-center justify-center">
          <h2 className="text-4xl md:text-5xl font-extrabold text-[#232323] text-center leading-tight" style={{fontFamily: 'Montserrat, Arial, sans-serif'}}>
